...
class ImageClassifierHelper(
    ...
    private fun setupImageClassifier() {
        ...
        try {
            ...
            Log.e(ImageClassifierHelper::class.simpleName, e.message.toString())
        }
    }
    ...
    fun classifyStaticImage(imageUri: Uri) {
        ...
        val tensorImage = imageProcessor.process(TensorImage.fromBitmap(imageUri.asBitmap()))
    ...
    private fun Uri.asBitmap(): Bitmap {
